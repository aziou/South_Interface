...
using System.Xml;
using System.IO;
namespace DataCore.Global
{
     public  class GB_Base
    {
         #region 变量
        ...
        public static bool ReportSuccess;

        public static string MeterCheckDate;

        public static string ExcelReportName;

        public static string ExcelResult="false";

       public static bool IsFakeData = Convert.ToBoolean(ReadElement("NewUser/CloumMIS/Item", "Name", "IsFakeData", "Value", "false", System.AppDomain.CurrentDomain.BaseDirectory + @"\config\NewBaseInfo.xml"));
        //public static bool IsFakeData = false;
        public static string MeterZcbh;

        public static string MeterCheckTime = "";

        public static string MeterCheckName = "";

        public static string  FirstCheckFlag="1";

        public static string SoftType = ReadElement("NewUser/CloumMIS/Item", "Name", "cmb_SoftType", "Value", "", System.AppDomain.CurrentDomain.BaseDirectory + @"\config\NewBaseInfo.xml");

        public static string MeterGZDBH;

        //strXBDM = "", strJDTime = "";BaseConfigPath

        public static string MeterXBDM="";

        public static string MeterId = "";

        public static string LogPath = ReadElement("NewUser/CloumMIS/Item", "Name", "txt_Report", "Value", "", System.AppDomain.CurrentDomain.BaseDirectory + @"\config\NewBaseInfo.xml");
        
        public static string CompanyDQBH = ReadElement("NewUser/CloumMIS/Item", "Name", "txt_CompanyNum", "Value", "", System.AppDomain.CurrentDomain.BaseDirectory + @"\config\NewBaseInfo.xml");
       
        public static string BaseConfigPath = System.AppDomain.CurrentDomain.BaseDirectory + @"\config\NewBaseInfo.xml";
        ...
        public static string MultiCheckTime = "";
        ...
        #region 报表变量
        public static string CheckTimeCondition = "";
